...
{
    [Guid("8103f6d5-7ca0-4259-a28a-aea844abff68")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": ToObjPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": ToObjPlugin: deactivating... ");
